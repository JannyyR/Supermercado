...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2025 a las 05:43:06
...
--
ALTER TABLE `inventario_sucursal`
  ADD CONSTRAINT `inventario_sucursal_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`producto_id`),
  ADD CONSTRAINT `inventario_sucursal_ibfk_2` FOREIGN KEY (`sucursal_id`) REFERENCES `sucursales` (`sucursal_id`);
